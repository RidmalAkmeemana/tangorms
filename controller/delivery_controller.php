        ...
        try {
            ...
            if ($order_status === "Rejected" && $payment_status !== "Unpaid") {
                echo "<script>
                    ...
                    window.location = '../view/view-delivery-orders.php';
                </script>";
                exit();
            }
            ...
            if ($order_status === "Rejected") {
                ...
                $deliveryObj->updateOrderStatus($receipt_no, $order_status, $reason);
            } else {
                $deliveryObj->updateOrderStatus($receipt_no, $order_status, null);
            }

            $msg = base64_encode("Order status updated successfully.");
            echo "<script>window.location = '../view/view-delivery-orders.php?msg=$msg';</script>";
            exit();
