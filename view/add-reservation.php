...
$reservationResult = $reservationObj->getReservationNo();
...
<body>
    <div class="container">
        ...
        <div class="row">
            ...
            <form class="col-md-9" action="../controller/reservation_controller.php?status=add_reservation" method="post">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4"><input type="text" class="form-control" name="reservation_no" value="<?= $reservationResult; ?>" readonly></div>
                    ...
                    <div class="col-md-4">
                        <select name="table_id" id="table_id" class="form-control" required>
                            ...
                            <?php while ($tableRow = $tableResult->fetch_assoc()): ?>
                                <option value="<?= $tableRow['table_id']; ?>"><?= $tableRow['table_name']; ?></option>
                            <?php endwhile; ?>
                        </select>
                    </div>

                    <div class="col-md-2"><label class="control-label">Reservation Date:</label><label class="text-danger">*</label></div>
                    <div class="col-md-4"><input type="date" class="form-control" name="reserved_date"></div>
                </div>
