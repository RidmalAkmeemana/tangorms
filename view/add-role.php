...
<body>
    <div class="container">
        <?php $pageName = "ROLE MANAGEMENT";
        include_once "../includes/header_row_includes.php"; ?>

        <div class="row">
            <?php require 'role-management-sidebar.php'; ?>

            <form class="col-md-9" action="../controller/role_controller.php?status=add_role" method="post" enctype="multipart/form-data">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4"><input type="text" class="form-control" name="role_name" id="role_name" required /></div>
                </div>
