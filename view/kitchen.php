...
$orderstatusCounts = $kitchenObj->getOrderStatusCounts();
...
$deliveringCount = $orderstatusCounts['delivering_count'];
$completedCount = $orderstatusCounts['completed_count'];
$rejectedCount = $orderstatusCounts['rejected_count'];
$canceledCount = $orderstatusCounts['canceled_count'];
?>
...
<body>
    <div class="container">
        ...
        <div class="col-md-9 row">
            ...
            <div class="col-md-6">
                <div class="panel panel-info" style="height:180px">
                    <div class="panel-heading">No of Delivering Orders</div>
                    <div class="panel-body">
                        <h1 class="h1"><?= $deliveringCount; ?></h1>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="panel panel-info" style="height:180px">
                    <div class="panel-heading">No of Out of Canceled Orders</div>
                    <div class="panel-body">
                        <h1 class="h1"><?= $canceledCount; ?></h1>
                    </div>
                </div>
            </div>
