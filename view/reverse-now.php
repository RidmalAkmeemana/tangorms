...
<body>
    <div class="container">
        ...
        <div class="row">
            ...
            <form class="col-md-9" action="../controller/purchasing_controller.php?status=reverse_payment" method="post">
                ...
                <div class="row mt-3 text-center">
                    <div class="col-md-12">
                        <input type="submit" class="btn btn-primary" value="Reverse Payment Now">
